  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
        <Card className="w-full mx-auto max-w-xs bg-dark-tremor-background-muted">
      ...
      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content-strong text-center sm:left font-semibold text-xl">
          This weeks top visitors:
        </h2>
        <div className="col-spn-3 flex items-center justify-between flex-wrap gap-8">
      ...
      <Card className="bg-dark-tremor-background-muted mx-auto">
        {timeseriesPageViews ? (
          <BarChart
            allowDecimals={false}
            showAnimation
